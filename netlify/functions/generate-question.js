...
function styleGuidance(markingStyle) {
  switch (markingStyle) {
    ...
    case 'language':
      return `Write ONE short Year 8 question for this modern foreign language. Vary the type across: vocabulary recall, translation into English, translation from English, choosing or conjugating the correct verb tense, or a short writing task of 2–3 sentences (topics: holidays, going out, daily routine/health, school). Keep vocabulary and grammar at KS3 Year 8 level. Write the instruction in English and put any target-language text in the "question". Give a small mark tariff (1–8). Do not include the answer.`;
