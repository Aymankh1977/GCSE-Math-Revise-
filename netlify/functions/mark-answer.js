...
function markGuidance(markingStyle) {
  switch (markingStyle) {
    ...
    default: // essay — humanities & vocational
      return `Mark like a KS3 teacher using a levels-based mark scheme appropriate to the command word and tariff. Reward knowledge, application, analysis and (where relevant) evaluation/judgement. Provide indicative content / model points rather than a long essay.`;
  }
}
